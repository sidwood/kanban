...
pub fn schema_definitions() -> Vec<(&'static str, RootSchema)> {
    vec![
        ...
        (
            ...
            schema_for!(crate::AttentionSubjectKind),
        ),
        (
            "AttentionItemRecord",
            schema_for!(crate::AttentionItemRecord),
        ),
        ("AttentionListQuery", schema_for!(crate::AttentionListQuery)),
        (
            "AttentionListResponse",
            schema_for!(crate::AttentionListResponse),
        ),
        (
            "AttentionAcknowledgeRequest",
            schema_for!(crate::AttentionAcknowledgeRequest),
        ),
        (
            "NotificationSettingsQuery",
            schema_for!(crate::NotificationSettingsQuery),
        ),
        (
            "NotificationSettingsRecord",
            schema_for!(crate::NotificationSettingsRecord),
        ),
        (
            "NotificationSettingsUpdateRequest",
            schema_for!(crate::NotificationSettingsUpdateRequest),
        ),
        (
            "NotificationPermissionState",
            schema_for!(crate::NotificationPermissionState),
        ),
        (
            "NotificationPermissionRecord",
            schema_for!(crate::NotificationPermissionRecord),
        ),
        (
            "NotificationPermissionQuery",
            schema_for!(crate::NotificationPermissionQuery),
        ),
        (
            "NotificationPermissionRequest",
            schema_for!(crate::NotificationPermissionRequest),
        ),
        (
            "NotificationPermissionResponse",
            schema_for!(crate::NotificationPermissionResponse),
        ),
        (
            "NotificationChannel",
            schema_for!(crate::NotificationChannel),
        ),
        ("NotificationTarget", schema_for!(crate::NotificationTarget)),
        (
            "NotificationDeliveryStatus",
            schema_for!(crate::NotificationDeliveryStatus),
        ),
        (
            "NotificationDeliveryRecord",
            schema_for!(crate::NotificationDeliveryRecord),
        ),
        (
            "NotificationDeliveriesQuery",
            schema_for!(crate::NotificationDeliveriesQuery),
        ),
        (
            "NotificationDeliveriesResponse",
            schema_for!(crate::NotificationDeliveriesResponse),
        ),
        (
            "NotificationRetryRequest",
            schema_for!(crate::NotificationRetryRequest),
        ),
